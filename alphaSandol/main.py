...
def go_function(function_name:list) ->dict:
    ...
    key_set = {
        'weather' : Module.CrawlingFunction.weather(Module.CrawlingFunction, param[key[0]]),
        'covid' : Module.CrawlingFunction.today_covid(Module.CrawlingFunction),
        'feedback_upload' : None,
        'read_feedback' : None,
        'perm_chk' : None,
        'store_name' : None,
        'read_meal' : None,
