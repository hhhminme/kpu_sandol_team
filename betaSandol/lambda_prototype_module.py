    ...
    def weather(self, location):
        ...
        try:
            ...
            try:
                ...
                return gen.is_Text("[Crawling-Error #011] 찾는 지역이 없습니다" + imoge_mapping['emotion']['paw'] + " '시' 또는 '도'의 이름을 입력해주세요! ex)시흥 날씨")  # 이 부분 오류 메시지로 대체하면 됩니다
...
class Test():
    def returnType(self):
        try:
            ...
            a = gen.is_Card("https://avatars.githubusercontent.com/u/25563122?v=4", is_description="Button Test2")
        return a
